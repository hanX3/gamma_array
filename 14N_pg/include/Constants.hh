...
// Ge
constexpr G4double Ge_ARRAY_R        = 5000. * mm; // Ge Array R
...
constexpr G4double CSI_SIZE_X         = 10. * mm;
constexpr G4double CSI_SIZE_Y         = 10. * mm;
constexpr G4double CSI_THICKNESS      = 5. * mm;
constexpr G4double MYLAR_SIZE_X       = 10. * mm;
constexpr G4double MYLAR_SIZE_Y       = 10. * mm;
...
// Resolution
constexpr G4double RESOLUTION = 0.01;
