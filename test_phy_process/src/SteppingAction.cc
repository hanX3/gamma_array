...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
  ...
  if(edep>0 && strcmp(detectorName, "Ge")==0){
    G4cout << eventID << " " << edep << " " << trackID << " " << particleName << " " << detectorName << " " << prex << " " <<  prey << " " << prez << " " << preTotalEnergy << " " << preKineEnergy << " " <<postx << " " << posty << " " << postz << " " << postTotalEnergy << " " << postKineEnergy << " " << stepLength << " " << processName << G4endl;
  }
}
